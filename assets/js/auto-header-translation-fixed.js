...
(function() {
    ...
    window.XTRANUMERIK_HEADER_CONFIG_FIXED = CONFIG;
    ...
    function initializeHeaderInteractions() {
        ...
        if (langSwitch) {
            ...
            langSwitch.addEventListener('click', function(event) {
                ...
                // Ajouter un petit délai pour voir les logs (optionnel)
                setTimeout(() => {
    ...
    console.log('🎯 📋 Pour tester: CONFIG disponible via window.XTRANUMERIK_HEADER_CONFIG_FIXED');
